...
export function FeaturedProjectJobAI() {
  const { t } = useTranslation("common");

  const features = t("jobAI.features", {
    returnObjects: true,
  }) as string[];
    ...
    <section className="flex flex-col items-center gap-12 px-6 py-16 md:px-12 md:py-16 lg:px-20 lg:py-20">
      ...
      <div className="flex w-full max-w-6xl flex-col items-center gap-10 md:flex-row md:items-start md:gap-8 lg:gap-12">
        ...
        <div className="flex flex-col gap-6 md:w-2/5">
          {/* Title */}
          <h3 className="text-3xl font-bold text-foreground">JobAI</h3>

          {/* Technical Highlight */}
          <p className="font-mono text-xs text-accent">
            {t("jobAI.technicalHighlight")}
          </p>
          ...
          <div className="flex flex-col gap-3 pt-2 sm:flex-row sm:flex-wrap sm:gap-3 md:gap-4">
            <Button href="https://esteban-jobai.duckdns.org/">
              {t("jobAI.cta.liveDemo")}
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
            ...
            <Button href="/case-study/job-ai" variant="outline">
              {t("jobAI.cta.caseStudy")}
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
